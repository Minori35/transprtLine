...
import { EditComponent } from './quotation/edit/edit.component';

@NgModule({
    imports: [RouterModule.forChild([
        { path: 'order', data: { breadcrumb: 'Button' }, loadChildren: () => import('./button/buttondemo.module').then(m => m.ButtonDemoModule) },
        { path: 'quotation', data: { breadcrumb: 'Form Layout' }, loadChildren: () => import('./quotation/formlayoutdemo.module').then(m => m.FormLayoutDemoModule) },
        { path: 'carrier', data: { breadcrumb: 'File' }, loadChildren: () => import('./file/filedemo.module').then(m => m.FileDemoModule) },
        ...
        { path: 'quotation/edit/:id', data: { breadcrumb: 'Form Layout' }, component: EditComponent},
